export const login_user = async (formData: unknown) => {
    try {
        const res = await fetch('https://chat-backend-z4zv.onrender.com/api/login-user', {
            method: 'POST',
            headers: {
...
export const register_user = async (formData: unknown) => {
    try {
        const res = await fetch('https://chat-backend-z4zv.onrender.com/api/register-user', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const get_all_users = async (id: unknown , token  : string) => {
    ...
    try {
        const res = await fetch(`https://chat-backend-z4zv.onrender.com/api/get-all-users?id=${id}`, {
            method: 'GET',
            headers : {
...
export const getChatData = async (data: any , token  : string) => {
    ...
    try {
        const res = await fetch(`https://chat-backend-z4zv.onrender.com/api/get-user-chat?senderId=${senderId}&receiverId=${receiverId}`, {
            method: 'GET',
            headers : {
                'authorization': `Bearer ${token}`
            },
...
export const getGroupChatData = async (data: any, token  : string) => {
    ...
    try {
        const res = await fetch(`https://chat-backend-z4zv.onrender.com/api/get-group-chat?senderId=${senderId}&receiverId=${receiverId}&groupId=${groupId}`, {
            method: 'GET',
            headers : {
                'authorization': `Bearer ${token}`
            },
...
export const send_message = async (formData: any , token  : string) => {
    ...
    try {
        const res = await fetch(`https://chat-backend-z4zv.onrender.com/api/send-user-message`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'authorization': `Bearer ${token}`
...
export const create_group  =  async (formData: any , token  : string) => {
    try {
        const res = await fetch(`https://chat-backend-z4zv.onrender.com/api/create-group`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'authorization': `Bearer ${token}`
...
export const get_user_group  = async (id: any , token  : string) => {
    try {
        const res = await fetch(`https://chat-backend-z4zv.onrender.com/api/get-user-group?id=${id}`, {
            method: 'GET',
            headers : {
                'authorization': `Bearer ${token}`
            },
...
export const send_group_message = async (formData: any , token  : string) => {
        ...
        try {
            const res = await fetch(`https://chat-backend-z4zv.onrender.com/api/send-group-message`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'authorization': `Bearer ${token}`
...
export const delete_group = async (ownerId  : string, groupId : string, token  : string) => {
    ...
    try {
        const res = await fetch(`https://chat-backend-z4zv.onrender.com/api/delete-group?ownerId=${ownerId}&groupId=${groupId}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'authorization': `Bearer ${token}`
...
export const delete_messages_from_me = async (deletingData : any ,token  : string) => {
    ...
    try {
        const res = await fetch(`https://chat-backend-z4zv.onrender.com/api/delete-group-message-from-me`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'authorization': `Bearer ${token}`
